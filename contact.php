...
<form class="bg-white rounded-2xl border p-6 grid gap-4 max-w-xl">
  <input class="border rounded-xl p-3" placeholder="Nom">
  <input class="border rounded-xl p-3" placeholder="Email">
  <textarea class="border rounded-xl p-3" placeholder="Message"></textarea>
  <button class="px-5 py-3 rounded-2xl bg-indigo-600 text-white">Envoyer</button>
</form>
</main>
