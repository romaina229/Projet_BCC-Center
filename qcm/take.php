...
<head>
<meta charset="utf-8">
<title><?= htmlspecialchars($quiz['title']) ?> - BCC-Center</title>
...
<main class="max-w-7xl mx-auto px-4 py-8">
  ...
  <form method="post" action="take_submit.php?id=<?= $quiz['id'] ?>" class="space-y-6">
    ...
    <?php endforeach; ?>
    <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-xl">Valider mes réponses</button>
  </form>
</main>
