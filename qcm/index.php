...
<h1 class="text-2xl font-bold mb-4">QCM disponibles</h1>
<div class="bg-white rounded-2xl border shadow">
  <?php if (count($quizzes) > 0): ?>
    <?php foreach($quizzes as $q): ?>
      <a href="/qcm/take.php?id=<?php echo intval($q['id']); ?>" 
    ...
    <?php endforeach; ?>
  <?php else: ?>
    <p class="p-4 text-gray-500">Aucun QCM disponible pour le moment.</p>
  <?php endif; ?>
</div>
</main>
