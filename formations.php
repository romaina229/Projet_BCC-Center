...
<h1 class="text-2xl font-bold mb-4">Catalogue des formations</h1>
<p class="mb-6 text-gray-700">Liste des formations BCC-Center</p>
<div class="grid md:grid-cols-3 gap-6">
  <div class="p-5 bg-white rounded-2xl border shadow">
    <h3 class="font-semibold">Titre de formation</h3>
    <p class="text-sm text-gray-600">Courte description...</p>
    <a href="./formation_passer/programme.html" class="inline-block mt-3 text-indigo-600">Voir le programme</a>
  </div>
</div>
</main>
