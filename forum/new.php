...
<h1 class="text-2xl font-bold mb-4">Nouveau sujet</h1>
<form method="post" action="new_action.php" class="bg-white rounded-2xl border p-6 grid gap-3 max-w-xl">
  <input name="title" class="border rounded-xl p-3" placeholder="Titre" required>
  <textarea name="body" class="border rounded-xl p-3" placeholder="Votre message..." required></textarea>
