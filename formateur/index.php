...
<h1 class="text-2xl font-bold mb-4">Espace formateur</h1>
<div class="grid md:grid-cols-3 gap-6">
  <a href="/formateur/consignes.php" class="p-6 bg-white rounded-2xl border shadow">Déposer des consignes</a>
