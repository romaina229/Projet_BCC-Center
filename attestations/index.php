...
<h1 class="text-2xl font-bold mb-4">Attestation</h1>
<?php if($eligible): ?>
  <a href="../generate_certificart.php" class="px-5 py-3 rounded-2xl bg-indigo-600 text-white inline-block">Télécharger mon attestation</a>
<?php else: ?>
  <p>Vous n'êtes pas encore éligible. Terminez toutes les tâches et QCM.</p>
<?php endif; ?>
</main>
